...
| 日期 | 发布 | 记录内容 |
| --- | --- | --- |
| 2026-09-26 | [Web 桌面聊天与独立管理](WEB_DESKTOP_WORKSPACE_RELEASE_2026-09-26.md) | 我的 agents 三栏、独立功能页、管理删除/恢复；Web 264 项、故事 13 项、桌面 8 项、公网匿名 32/双账号 115 项通过；本轮 46 用户/41 连接与四库保留 |
| 2026-09-26 | [Web 聊天与合作工作流](WEB_CHAT_COLLABORATION_RELEASE_2026-09-26.md) | P0/P1 已上线、SDK v0.9.3；Web 244 项、完整故事 10 项、公网匿名 32 项/双账号 93 项通过，原 46 用户/43 连接与四库保留 |
